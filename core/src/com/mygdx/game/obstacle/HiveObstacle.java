 ...
 */
public class HiveObstacle extends SimpleObstacle {
     ...
     */
    public HiveObstacle(float width, float height) {
     ...
     * @param height	The object width in physics units
     */
    public HiveObstacle(float x, float y, float width, float height) {
        super(x,y);
