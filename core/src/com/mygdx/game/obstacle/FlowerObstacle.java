 ...
 */
public class FlowerObstacle extends SimpleObstacle {
     ...
     */
    public FlowerObstacle(float width, float height) {
     ...
     * @param height	The object width in physics units
     */
    public FlowerObstacle(float x, float y, float width, float height) {
        super(x,y);
