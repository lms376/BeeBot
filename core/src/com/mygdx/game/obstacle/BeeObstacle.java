 ...
 */
public class BeeObstacle extends SimpleObstacle {
     ...
     */
    public BeeObstacle(float width, float height) {
     ...
     * @param height	The object width in physics units
     */
    public BeeObstacle(float x, float y, float width, float height) {
     ...
     * @param height	The object width in physics units
     */
    public BeeObstacle(float x, float y, float width, float height, Orientation o) {
        super(x,y);
